import torch
import os
from model_FM_context import ContextFactorizationMachineModel
from train import testpartial, train_one_epoch_context
from build_dataset_context import CustomerArticleDataset
...
if __name__ == '__main__':
    ...
    model = ContextFactorizationMachineModel(full_dataset.field_dims, 32).to(device)
