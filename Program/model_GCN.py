...
class GraphModel(torch.nn.Module):
    # generates different types of GCN embeddings as a function of the attention parameter value
...
class FactorizationMachineModel_withGCN(torch.nn.Module):
    # generates Factorization Machine Model with pairwise interactions using GCN embeddings
