...
if __name__ == '__main__':
    ...
    for epoch_i in range(num_epochs):
        ...
        if tb:
            tb_gcn.add_scalar(f'train/loss', train_loss, epoch_i)
            tb_gcn.add_scalar(f'eval/HR@{topk}', hr, epoch_i)
            tb_gcn.add_scalar(f'eval/NDCG@{topk}', ndcg, epoch_i)
            tb_gcn.add_scalar(f'eval/COV@{topk}', coverage, epoch_i)