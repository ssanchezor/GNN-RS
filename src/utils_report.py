...
if __name__ == '__main__':
    ...
    #from train_features import testpartial, train_one_epoch
    ...
    PATH="FactorizationMachineModel_withGCN_epoch15.pt"
    attention = False
    ...
    #        full_dataset, dict_recomend, title="FactorizationMachineModel_withGCN_80000" , topk=10 )
